...
int main()
{
    ...
    XLCellValue vA2 = wks.cell("A2").value();
    XLCellValue vB2 = wks.cell("B2").value();
    XLCellValue vC2 = wks.cell("C2").value();
    cout << "Value in B2: " << vB2 << endl;
    cout << "Value in C2: " << vC2 << endl;
    cout << "Value in D2: " << vC2 << endl << endl;
